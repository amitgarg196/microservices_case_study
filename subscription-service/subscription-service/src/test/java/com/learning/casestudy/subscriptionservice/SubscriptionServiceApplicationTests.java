...
class SubscriptionServiceApplicationTests {
	...
	public void testCreateSubscriptions() throws Exception {
		...
		Subscription subscription = new Subscription(99999, "Prerna Khera", formatter.parse("2020-05-05"), formatter.parse("2020-05-15"), "B1001");	
		...
		for (Subscription subscription1 : subscriptions) {
			if (subscription1.getSubscriptionId() == 101) {
				...
				assertThat(subscription1.getSubscriberName()).isEqualTo("Amit Khera");
				assertThat(subscription1.getDateSubscribed()).isEqualTo("2020-05-05");
				assertThat(subscription1.getDateReturned()).isEqualTo("2020-05-15");
	...
	public void testCreateSubscriptions_WhenInvalidBookId() throws ParseException {
		...
		Subscription subscription = new Subscription(101, "Amit Khera", formatter.parse("2020-05-05"), formatter.parse("2020-05-15"), "B1009");	
		ResponseEntity<HttpStatus> statusResponse = subscriptionController.createSubscription(subscription);
		HttpStatus status = statusResponse.getBody();
	...
	public void testCreateSubscriptions_WhenAvailableCountIsZero() throws Exception {
		...
		Subscription subscription = new Subscription(101, "Amit Khera", formatter.parse("2020-05-05"), formatter.parse("2020-05-15"), "B1001");
